...
if __name__ == "__main__":
    ...
    parser.add_argument('url', metavar='URL', type=str, nargs=1, default="http://localhost:8000/",
                        help='Base url to upload files to')
    parser.add_argument('username', metavar='username', type=str, nargs=1, default="username",
                        help='Username')
    parser.add_argument('password', metavar='password', type=str, nargs=1, default="password",
                        help='Password')
